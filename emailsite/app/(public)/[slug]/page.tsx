...
import BlogPostClient from "@/app/(public)/blog/[slug]/BlogPostClient";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://www.mailexel.com/${slug}` },
    openGraph: {
      title,
      description,
      url: `https://www.mailexel.com/${slug}`,
      type: "article",
...
export default async function PostPage({ params }: Props) {
  ...
  const schema = {
    ...
    author: { "@type": "Person", name: post.author?.name ?? "MailExel Team" },
    publisher: {
      "@type": "Organization",
      name: "MailExel",
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `https://www.mailexel.com/${slug}` },
  };
