...
import { ClipboardList, Plus, Trash2, CheckCircle2, Clock, Send, XCircle } from "lucide-react";

type BlogTask = { id: string; title: string; status: string; createdAt: string; updatedAt: string };
